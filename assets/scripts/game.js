    ...
    for (let circle of document.getElementsByClassName("circle")) {
        if (circle.getAttribute("data-listener") != "true") {
            ...
            circle.addEventListener("click", (e) => {
                ...
                playerTurn();   // this function is not written yet
            });
...
function addTurn() {
    ...
    /* On the code on line 29 below, we'll use the Math.random() library to generate a random number 
...
function lightsOn(circ) {
    /* On line 43, the class of light will be added to our appropriate circle by gettig 
...
function playerTurn() {
    ...
    /* What the code on line 97 does is that it compares the element at index i of currentGame array with that 
    ...
    } else {  //If both lengths aren't equal, then display an alert that says "Wrong move!" as written on line 104
        alert("Wrong move!");
        newGame();
    }
}
